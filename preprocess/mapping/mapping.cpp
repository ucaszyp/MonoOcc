                                 ...
                                 const double lo_free)
{
    ...
    const int vxsize = (pxmax - pxmin) / voxel_size;
    const int vysize = (pymax - pymin) / voxel_size;
    const int vzsize = (int)((pzmax - pzmin) / voxel_size);
    const Eigen::Vector3i grid_size(vxsize, vysize, vzsize);

    // std::cout << "x: " << pxmin << ", " << pxmax << std::endl;
    // std::cout << "y: " << pymin << ", " << pymax << std::endl;
    // std::cout << "z: " << pzmin << ", " << pzmax << std::endl;
    ...
    // std::cout << "vx: " << vxsize << std::endl;
    // std::cout << "vy: " << vysize << std::endl;
    // std::cout << "vz: " << vzsize << std::endl;
