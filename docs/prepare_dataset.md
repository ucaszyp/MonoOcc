...
1. Direct downloading
      ...
      -  The **calibration and pose** files from MonoOcc/preprocess/data_odometry_calib/sequences.
...
2. Downloading the voxel and image data first, then following the commands in *MonoOcc/preprocess* to create **labels** and **sequences_msnet3d_sweep10**. You need to choose this option if you would like to use different data or depth models.
