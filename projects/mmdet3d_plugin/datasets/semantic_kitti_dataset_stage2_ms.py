...
class SemanticKittiDatasetStage2_ms(Dataset):
    def __init__(
        self,
        split,
        test_mode,
        ...
        splits = {
            "train": ["03", "04", "05", "00", "01", "02", "06", "07", "09", "10"],
            "val": ["08"],
        ...
        # TODO: confirm the size n * 32 for cvt
        # origin 376 1241
        # resize 384 1248
        self.img_W = 1220
        self.img_H = 370
    ...
    def get_data_info(self, index):
        ...
        img, sem, lidar = self.get_input_info(sequence, frame_id)
    ...
    def get_meta_info(self, scan, sequence, frame_id, proposal_path):
        ...
        # proposal_path_2 = proposal_path.replace("queries", "queries_2")
        # proposal_bin_2 = self.read_occupancy_SemKITTI(proposal_path_2)
        proposal_path_4 = proposal_path.replace("queries", "queries_4")
        proposal_bin_4 = self.read_occupancy_SemKITTI(proposal_path_4)
        proposal_path_8 = proposal_path.replace("queries", "queries_8")
        proposal_bin_8 = self.read_occupancy_SemKITTI(proposal_path_8)
        proposal_bins = [proposal_bin, proposal_bin_4, proposal_bin_8]

        meta_dict = dict(
            sequence_id = sequence,
            frame_id = frame_id,
            proposal=proposal_bins,
