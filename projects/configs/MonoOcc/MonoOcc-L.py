...
model = dict(
   type='MonoOcc',
   pretrained=dict(img='/DATA_EDS2/zyp/Workspace/InternImage/iter_pretrain.pth'),
   img_backbone=dict(
        _delete_=True,
        type='InternImage',
        core_op='DCNv3',
        ...
        with_cp=False,
        out_indices=(2,),
        init_cfg=dict(type='Pretrained', checkpoint='ckpts/internimage.pth')),
   img_neck=dict(
       type='FPN',
       in_channels=[768],
       out_channels=_dim_,
